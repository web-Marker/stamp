import type { IInnerCircle } from './DrawStampTypes'
...
export class DrawCircleUtils {
  ...
  drawCircle(
    ...
    const innerCircleWidth =
      (circle.innerCircleLineRadiusX - circle.innerCircleLineWidth) / 2
    const innerCircleHeight =
      (circle.innerCircleLineRadiusY - circle.innerCircleLineWidth) / 2
    this.drawEllipse(
      ctx,
      centerX,
      centerY,
